...
private:
    ...
    Texture2D mBackground; // background image
    Rectangle mBackgroundSource; // background source
    Rectangle mBackgroundDestination; //  background destination
    ...
    float mBackgroundScroll = 0.0f;
    float mBackgroundScrollSpeed = 50.0f;

    const char *backgroundFilePath = "assets/PurpleNebulaBackgorund.png";
